...
/datum/job/psychiatrist
	...
	alt_titles = list(
		...
		"Psychologist" = /decl/hierarchy/outfit/job/sierra/crew/medical/counselor/mentalist,
		"Therapist" = /decl/hierarchy/outfit/job/sierra/crew/medical/counselor/mentalist,
		"Psychiatrist" = /decl/hierarchy/outfit/job/sierra/crew/medical/counselor/mentalist
	)
...
/datum/job/psychiatrist/get_description_blurb()
	return "Вы - друг, наставник, священник... Или обычный психотерапевт. Вашей основной задачей является обеспечение \
	персонала качественной (насколько это возможно) психологической помощью. Будучи советником, у вас имеется \
	особенность - вы псионически одарены. Корпорация хорошо платит вам за то, чтобы вы проводили псионическое \
	обследования членов экипажа на предмет обладания особыми силами, естественно, с отчетом об этом. Ваша зарплата \
	превышает таковую у среднестатистческого менталиста из Фонда, и, вероятно, не просто так.<hr> \
	В то время, как Менталист склонен к исправлению психологических недугов, поиску псионики и даже \
	чтению мыслей, Советник может проводить медицинскую диагностику и слабое лечение."
