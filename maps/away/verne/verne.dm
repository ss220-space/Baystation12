...
/obj/item/paper/verne/combustion
	...
	info = "<center><h2>Напоминание о технике безопасности при нагреве топлива</h2></center><BR>\
		<hr><BR>\
		Внесу немного ясности для техников, которые еще не освоились с нашей системой. Нагревать топливо в камере сгорания нужно <u>крайне аккуратно</u>. Если закачать слишком много газа в камеру, температура горения будет слишком высокой, и она разобьет это стекло и возможно даже поплавит стенки камеры.<BR>\
		...
		Если вы заметили, что стекло начинает трескаться или уже разбилось, немедленно отключите инжектор и откройте створки в космос для вентилирования камеры сгорания. Убедитесь, что окно также защищено створками. Ни в коем случае не допускайте пожар в этом отсеке.<BR>\
		<hr><BR>\
		<small>Подпись:</small> <i>Главный Инженер Д. Френч</i>"