...
/datum/job/submap/merchant
	...
	whitelisted_species = null
	blacklisted_species = list(SPECIES_ADHERENT, SPECIES_NABBER, SPECIES_ALIEN, SPECIES_GOLEM, SPECIES_MANTID_GYNE, SPECIES_MANTID_ALATE, SPECIES_MONARCH_WORKER, SPECIES_MONARCH_QUEEN, SPECIES_XENO)
