...
/datum/map_template/ruin/away_site/liberia //Основной файл
	...
	spawn_cost = 2000 //Стоимость самой авейки
	player_cost = 0 //Стоимость авейки в игроках
	spawn_weight = 999 //HABITABLE SHIPS SPAWN | Шанс спавна. Нельзя ставить 0, иначе подбор авеек сломается. Дробные допускаются, желательно до сотых ~bear1ake
