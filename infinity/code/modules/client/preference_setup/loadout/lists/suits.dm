/datum/gear/suit/sec_jacket
	display_name = "private security jacket"
	path = /obj/item/clothing/suit/storage/toggle/agent_jacket/security
	allowed_roles = list(/datum/job/detective, /datum/job/officer, /datum/job/hos)

/datum/gear/suit/bombernew
	display_name = "bomber jacket renewed"
...
/datum/gear/suit/lettermanb
	display_name = "brown letterman jacket"
	path = /obj/item/clothing/suit/storage/lettermanb

/datum/gear/suit/lettermanr
	display_name = "red letterman jacket"
...
/datum/gear/suit/militarynew
	display_name = "redesigned military jacket"
