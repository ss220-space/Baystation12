...
/proc/generate_code_phrase()//Proc is used for phrase and response in subsystem init.
	...
	var/drinks[] = list("водка тоник","джин физ","багама мама","манхэттэн","черный русский","виски с содовой","лонг айленд","маргарита","кофе по ирландски","отважный дворф","ирдандские сливки","докторское наслаждение","удар бипски","текила санрайз","храбрый бык","гаргл бластер","кровавая мэри","виски с колой","белый русский","водка мартини","мартини","куба либрэ","кахлуа","водка","вино","moonshine")
