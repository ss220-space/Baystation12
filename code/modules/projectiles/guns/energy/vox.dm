...
/obj/item/gun/energy/darkmatter
	...
	firemodes = list(
		...
		list(mode_name="focused", burst=1, fire_delay=15,  burst_accuracy=list(30), dispersion=null, projectile_type=/obj/item/projectile/beam/darkmatter, charge_cost = 100),
