...
/datum/hallucination/talking/start()
	...
	for(var/mob/living/talker in oview(holder))
		...
		speech_bubble.plane = FLOAT_PLANE
...
/datum/hallucination/evacuation/start()
	...
	to_chat(holder, "<h1 class='alert'>Priority Announcement</h1><br>[(replacetext(GLOB.using_map.emergency_shuttle_docked_message, "%ETD%", "3 minutes"))]")
...
/datum/hallucination/fake_appearance/start()
	...
	switch(fake_type)
		...
		if("animal")
			fake_candidates = get_living_sublist(list(/mob/living/simple_animal), list(/mob/living/simple_animal/friendly/mouse))
		if("xenomorph")
			fake_candidates = get_living_sublist(list(/mob/living/carbon/alien,/mob/living/simple_animal/hostile/meat/horrorsmall ,/mob/living/simple_animal/hostile/meat/horrorminer ,/mob/living/simple_animal/hostile/meat/humansecurity ,/mob/living/simple_animal/hostile/meat/strippedhuman ,/mob/living/simple_animal/hostile/meat/horror , /mob/living/simple_animal/hostile/vagrant,/mob/living/simple_animal/hostile/meat/abomination , /mob/living/simple_animal/hostile/meat))
		if("bot")
			fake_candidates = get_living_sublist(list(/mob/living/bot))
		if("mouse")
			fake_candidates = get_living_sublist(list(/mob/living/simple_animal/friendly/mouse))
		if("ghost")
