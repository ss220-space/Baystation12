...
/client/proc/lighting_show_verbs()
	...
	src << SPAN_NOTICE("Lighting debug verbs have been shown.")
...
/client/proc/lighting_hide_verbs()
	...
	src << SPAN_NOTICE("Lighting debug verbs have been hidden.")
	verbs -= admin_verbs_lighting
...
/client/proc/lighting_toggle_profiling()
	...
	if (!establish_db_connection(dbcon))
		usr << SPAN_WARNING("Unable to start profiling: No active database connection.")
		return
