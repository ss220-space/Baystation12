...
/obj/item/mech_equipment/mounted_system/circuit/attack_self(var/mob/user)
	..()

/obj/item/mech_equipment/mounted_system/circuit/attackby(obj/item/W as obj, mob/user as mob)
	if(isCrowbar(W))
		...
		return
	if(istype(W, /obj/item/device/electronic_assembly/large/exo_frame))
		if(holding)
